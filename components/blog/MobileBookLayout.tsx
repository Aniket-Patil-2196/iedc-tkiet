                ...
                <div className="space-y-0.5">
                  <h3
                    className={cn(
                      ...
                      "text-base font-bold text-[#0F1B44] tracking-tight leading-snug"
                    )}
                  >
                    {blog.title}
                  </h3>
                ...
                <div className="relative">
                  <p
                    className={cn(
                      ...
                      "text-[#1B2333] tracking-normal text-left text-[15px] leading-[1.7] [hyphens:manual] [overflow-wrap:anywhere]"
                    )}
                  >
                    {dropCap && (
