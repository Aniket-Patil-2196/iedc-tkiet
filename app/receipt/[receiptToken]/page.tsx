...
export default async function ReceiptPage({ params }: ReceiptPageProps) {
  ...
  const regData = {
    ...
    totalAmount: (registration as any).totalAmount,
    paymentMethod: registration.paymentMethod,
    paymentMode: (registration as any).paymentMode,
    department: (registration as any).department,
    upiTransactionRef: (registration as any).upiTransactionRef,
    upiId: (registration as any).upiId || null,
    upiQrUrl: (registration as any).upiQrUrl || null,
    installmentPlan: (registration as any).installmentPlan,
    installmentStatus: (registration as any).installmentStatus,
    rejectionReason: (registration as any).rejectionReason,
